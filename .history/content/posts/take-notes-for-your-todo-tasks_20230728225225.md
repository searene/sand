...
<div class="callout">
    ...
    <p><b>The following log is taken from the server with IP 192.168.10.50:</p>
    <pre>
    Finished processing user Joey's request, duration: 28 seconds.
    Finished processing user Rachel's request, duration: 32 seconds.
    </pre>
</div>
