...
3. The notes can guide you through solving the problem. This is the **MOST IMPORTANT** reason why you should take notes on your TODO task. As an old saying goes:
...
1. **It has to support adding notes on each TODO task.** Since we are talking about notes, this feature is an obvious one.
